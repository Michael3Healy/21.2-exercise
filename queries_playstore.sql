...
SELECT app_name FROM analytics WHERE rating IS NOT NULL AND min_installs < 50 ORDER BY rating DESC;
...
SELECT app_name, reviews, min_installs, (min_installs / reviews) AS installs_to_reviews FROM analytics WHERE min_installs > 100000 ORDER BY min_installs / reviews DESC LIMIT 1;
